          ...
          {contact.email && (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href={`mailto:${contact.email}`} className="font-medium text-indigo-600 hover:text-indigo-800 hover:underline">
                  {contact.email}
                </a>
              </div>
            </div>
          ...
          {contact.phone && (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href={`tel:${contact.phone}`} className="font-medium text-indigo-600 hover:text-indigo-800 hover:underline">
                  {contact.phone}
                </a>
              </div>
            </div>
