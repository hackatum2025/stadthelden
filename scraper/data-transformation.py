...
#     state_db_files = [
#         f
#         for f in os.listdir(BUNDESLAENDER_DIR)
#         if f.startswith("foundations_") and f.endswith(".duckdb")
#     ]

#     if not state_db_files:
#         print(f"No individual state database files found in '{BUNDESLAENDER_DIR}'.")
#         master_con.close()
#         return
...
#         state_db_path = os.path.join(BUNDESLAENDER_DIR, db_file)
#         try:
